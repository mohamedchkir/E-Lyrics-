      ...
      <div class="w-full rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 ">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form method="POST" class="space-y-4 md:space-y-6" action="loginScript.php">
            ...
            <button type="submit" name="login" class="w-full text-white border border-amber-300  hover:bg-amber-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Log In
            </button>
          </form>
        </div>
